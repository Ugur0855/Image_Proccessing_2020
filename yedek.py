...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.activeContourButton = QtWidgets.QPushButton(self.centralwidget)
        self.activeContourButton.setObjectName("activeContourButton")
        self.horizontalLayout.addWidget(self.activeContourButton)
        ...
        self.cannyButton.clicked.connect(self.cannyImage)
        self.activeContourButton.clicked.connect(self.activeContour)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.flipButton.setText(_translate("MainWindow", "Simetri(Dikey)"))
        self.videoButton.setText(_translate("MainWindow", "Video(Kenar Belirleme)"))
        ...
        self.activeContourButton.setText(_translate("MainWindow", "Active Contours"))
...
# Added code here
    ...
    def video(self):
        ...
        while True:
            ...
            # frame is an uint8 numpy.ndarray

            frame = cv2.GaussianBlur(frame, (7, 7), 1.41)
            frame = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)

            edge = cv2.Canny(frame, 10, 50)
